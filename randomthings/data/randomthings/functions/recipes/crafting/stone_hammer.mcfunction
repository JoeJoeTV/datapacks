...
execute if entity @s[tag=rth.hammer.craft.success1,tag=rth.hammer.craft.success2,tag=rth.hammer.craft.success3] if block ~ ~ ~ minecraft:dropper[facing=up]{Items:[{Slot:0b,id:"minecraft:cobblestone",Count:1b},{Slot:1b,id:"minecraft:cobblestone",Count:1b},{Slot:2b,id:"minecraft:cobblestone",Count:1b},{Slot:3b,id:"minecraft:stone_pickaxe",Count:1b},{Slot:4b,id:"minecraft:stone_pickaxe",Count:1b},{Slot:5b,id:"minecraft:stone_pickaxe",Count:1b},{Slot:7b,id:"minecraft:stick",Count:1b}]} unless block ~ ~ ~ minecraft:dropper[facing=up]{Items:[{Slot:6b}]} unless block ~ ~ ~ minecraft:dropper[facing=up]{Items:[{Slot:8b}]} run data merge block ~ ~ ~ {Items:[{Slot:4b,id:"minecraft:stone_pickaxe",tag:{CustomModelData:420001,CustomItemID:"randomthings:hammer",display:{Name:"{\"text\":\"Steinhammer\",\"italic\":false}"}},Count:1b}]}
