...
execute as @s[tag=pcp.tmp.found_item] at @s unless block ~ ~ ~ minecraft:dropper[facing=up]{Items:[{Slot:4b,tag:{CustomItemID:"randomthings:hammer"}}]} if score @s pcp.amt.cnt.uitm matches 12.. if block ~ ~ ~ minecraft:dropper[facing=up]{Items:[{Slot:0b,id:"minecraft:ender_eye",Count:1b},{Slot:2b,id:"minecraft:ender_eye",Count:1b},{Slot:3b,id:"minecraft:obsidian",Count:1b},{Slot:5b,id:"minecraft:obsidian",Count:1b},{Slot:6b,id:"minecraft:emerald",Count:1b},{Slot:7b,id:"minecraft:bamboo",Count:1b},{Slot:8b,id:"minecraft:emerald",Count:1b}]} run tag @s add pcp.tmp.success
