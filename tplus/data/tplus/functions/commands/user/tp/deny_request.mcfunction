...
execute if entity @a[tag=plib.plr.hasid,tag=ptpp.plr.secondary] run tellraw @a[tag=ptpp.plr.request,tag=ptpp.plr.secondary,limit=1] ["",{"text":"[","color":"white"},{"text":"TP","color":"dark_purple"},{"text":"LUS","color":"dark_green"},{"text":"]","color":"white"},{"text":" "},{"selector":"@s","color":"gold"},{"text":" hat die Teleportanfrage abgelehnt!","color":"red"}]
execute if entity @a[tag=plib.plr.hasid,tag=ptpp.plr.secondary] run tellraw @s ["",{"text":"[","color":"white"},{"text":"TP","color":"dark_purple"},{"text":"LUS","color":"dark_green"},{"text":"] Du hast die Teleportanfrage von ","color":"white"},{"selector":"@a[tag=ptpp.plr.request,tag=ptpp.plr.secondary,limit=1]","color":"gold"},{"text":"abgelehnt!","color":"white"}]
